...
<body id="page-top" class="bg-dark" style="background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0.8) 0%, rgba(0, 0, 0, 0.7) 75%, #000000 100%), url('{{ asset('assets/img/bg-masthead.jpg') }}'); background-position: center; background-repeat: no-repeat; background-attachment: fixed; background-size: cover; padding-top: 120px;">
    ...
    @extends('components.layouts.register')
    @section('content')
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content shadow-lg border-0 rounded-4">
            ...
            <div class="modal-header bg-primary text-white rounded-top-4">
                <h5 class="modal-title fw-semibold" id="createPublicationModalLabel">Crear Nueva Publicación</h5>
            ...
            <form action="{{ route('publications.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body px-4 py-3">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control rounded-3" name="title" id="title" value="{{ old('title') }}" required>
                            @error('title') <small class="text-danger">{{ $message }}</small> @enderror
                        </div>
                        <div class="col-md-6">
                            <label for="type" class="form-label fw-bold">Tipo de Desastre *</label>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="severity" class="form-label fw-bold">Severidad *</label>
                            <select class="form-select rounded-3" name="severity" id="severity" required>
                                <option value="" disabled selected>Seleccionar severidad</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control rounded-3" name="location" id="location" value="{{ old('location') }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control rounded-3" name="description" id="description" rows="4" required>{{ old('description') }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <select 
                        class="form-select border-primary fw-semibold text-dark bg-white" 
                        name="role_id" 
                        id="role_id" 
                        required
                    >
                        <option value="" disabled selected class="text-muted">Seleccionar rol</option>
                    ...
                    <div id="rolSeleccionado" class="mt-2">
                        <span class="badge bg-primary d-none" id="badgeRol"></span>
                    </div>
                </div>
